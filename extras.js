...
.v3d-main.v3d-walk .v3d-bar,.v3d-main.v3d-walk .v3d-presets,.v3d-main.v3d-walk .v3d-note,.v3d-main.v3d-walk .v3d-hint,.v3d-main.v3d-walk .v3d-prompt{display:none}
.v3d-main:fullscreen{position:relative}.v3d-main:fullscreen .v3d-bar,.v3d-main:fullscreen .v3d-presets,.v3d-main:fullscreen .v3d-note{display:none}
...
.v3d-stops{display:flex;gap:6px;flex-wrap:wrap}.v3d-stops button{border:0;border-radius:999px;padding:6px 12px;background:rgba(255,255,255,.16);color:#fff;font-weight:700;font-size:.82rem;cursor:pointer;white-space:nowrap}.v3d-stops button:hover{background:rgba(255,255,255,.28)}.v3d-stops button[aria-pressed=true]{background:#fff;color:#0b1b1c}
.v3d-walkbar{flex-wrap:wrap}.v3d-walkbar>span{flex:1;min-width:80px;text-align:right;opacity:.7}
@media (max-width:640px){.v3d-stops{overflow-x:auto;flex-wrap:nowrap;max-width:100%}.v3d-walkbar>span{display:none}}
.v3d-tip{position:absolute;z-index:6;pointer-events:none;padding:4px 9px;border-radius:7px;background:rgba(11,27,28,.86);color:#fff;font-size:.78rem;font-weight:600;white-space:nowrap}.v3d-tip[hidden]{display:none}@media (hover:none){.v3d-tip{display:none}}
...
.v3d-pills{display:flex;flex-wrap:wrap;border:1px solid var(--line);border-radius:10px;overflow:hidden;background:#fff}
.v3d-pills button{flex:1 1 auto;min-width:0;border:0;border-right:1px solid var(--line);background:#fff;padding:8px 10px;font:inherit;font-size:.84rem;font-weight:600;text-transform:none;letter-spacing:0;color:var(--ink);cursor:pointer;white-space:normal;line-height:1.2}
