...
const VIEW3D = {
  ...
  'cabinets': 'flat-files,fireproof,rotary,museum-cabinet', 'rotary-cabinets': 'rotary', 'museum-cabinets': 'museum-cabinet,hd-mobile-museum,textile-rack', 'art-screens': 'art-screens,wall-art',
  ...
  'military': 'weapons,hd-mobile,pallet-rack', 'museums': 'art-screens,wall-art,museum-cabinet,hd-mobile-museum,textile-rack', 'libraries': 'library,hd-mobile', 'material-handling-warehouse': 'hd-mobile-open,pallet-rack,mezzanine,vlm,workstation,wire-cage',
...
.v3d-opt select{border:0;background-color:#fff;border-radius:999px;padding:5px 26px 5px 10px;font:inherit;font-weight:600;color:var(--teal-dark);cursor:pointer;appearance:none;background-image:linear-gradient(45deg,transparent 50%,#0f7377 50%),linear-gradient(135deg,#0f7377 50%,transparent 50%);background-position:calc(100% - 13px) 55%,calc(100% - 8px) 55%;background-size:5px 5px;background-repeat:no-repeat}
.v3d-chk{padding:6px 12px 6px 10px}.v3d-chk input{accent-color:#0f7377;width:15px;height:15px;margin:0}
